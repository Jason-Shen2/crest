...
const UpdateStatusBannerComponent = () => {
    ...
    return (
        <Tooltip
            ...
            divClassName={`flex items-center gap-1 px-2 mb-1 h-[22px] text-xs font-medium text-black bg-accent rounded-sm transition-all ${isReady ? "cursor-pointer hover:bg-[var(--color-accenthover)]" : ""}`}
