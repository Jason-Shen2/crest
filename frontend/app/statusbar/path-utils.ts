...
//
// path-utils — split a working-directory / file path into breadcrumb
// segments, with special handling for the home directory.
//
// Ported from terax-ai/src/modules/statusbar/lib/pathUtils.ts.  The
// only change vs. upstream is the file header; semantics are identical
// so we don't have to keep two copies in sync forever (the helper is
