...
export const GraphRail = memo(function GraphRail({ row, rowHeight, maxLaneCount, active }: RailProps) {
    ...
    return (
        ...
        >
            ...
            {overflow ? (
                <text x={width - 4} y={midY + 3} textAnchor="end" className="fill-[#a1a1aa]" style={{ fontSize: 8 }}>
