...
const DefaultByteCap = 1024 * 1024;
const DefaultBlockSize = 16 * 1024;

// No \x1bc here: a full reset would erase the snapshot restored just before
// the drain, scrollback included.
const OverflowNotice = new TextEncoder().encode(
    "\r\n\x1b[0m\x1b[2m[crest: some output was dropped while this tab was hidden]\x1b[0m\r\n"
);
...
export class DormantRing {
    ...
    constructor(
        readonly byteCap = DefaultByteCap,
        readonly blockSize = DefaultBlockSize
    ) {}
