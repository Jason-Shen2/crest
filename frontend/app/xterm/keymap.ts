...
export type TerminalKeyEvent = Pick<KeyboardEvent, "altKey" | "ctrlKey" | "metaKey" | "key" | "code">;
...
export function terminalLineNavigationSequence(event: TerminalKeyEvent, opts: PlatformOpts): string | null {
 ...
 */
export function terminalDeleteSequence(event: TerminalKeyEvent, opts: PlatformOpts): string | null {
