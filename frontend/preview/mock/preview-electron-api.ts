...
const previewElectronApi: ElectronApi = {
    ...
    agent: {
        ...
        listRewindPoints: () => Promise.resolve({ points: [], semanticLeafId: null, displayLeafId: null }),
        getTurnChangeSummary: () => Promise.reject(new Error("agent not available in preview env")),
        getTurnFileDiff: () => Promise.reject(new Error("agent not available in preview env")),
        reviewTurnChanges: () => Promise.reject(new Error("agent not available in preview env")),
        previewTurnUndo: () => Promise.reject(new Error("agent not available in preview env")),
        applyTurnUndo: () => Promise.reject(new Error("agent not available in preview env")),
        previewTurnRedo: () => Promise.reject(new Error("agent not available in preview env")),
        applyTurnRedo: () => Promise.reject(new Error("agent not available in preview env")),
        previewRewind: () => Promise.reject(new Error("agent not available in preview env")),
        rewindTree: () => Promise.reject(new Error("agent not available in preview env")),
        redoRewind: () => Promise.reject(new Error("agent not available in preview env")),
        getWorkspaceRecovery: () => Promise.resolve(undefined),
        resolveWorkspaceRecovery: () => Promise.reject(new Error("agent not available in preview env")),
        cleanupWorkspaceCheckpoints: () => Promise.reject(new Error("agent not available in preview env")),
        listCheckpointStorageOwners: () => Promise.resolve({ trashOwners: [] }),
        purgeTrashedSession: () => Promise.reject(new Error("agent not available in preview env")),
