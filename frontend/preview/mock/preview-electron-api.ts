...
const previewElectronApi: ElectronApi = {
    ...
    setRightBrowserActiveWebContents: (_webContentsId: number | null) => {},
    ...
    agent: {
        ...
        runShortcut: () => Promise.reject(new Error("agent not available in preview env")),
        listFlags: () => Promise.resolve([]),
        setFlag: () => Promise.reject(new Error("agent not available in preview env")),
        getExtensionsGraph: () => Promise.resolve({ generation: 0, nodes: [] }),
        getSessionState: () => Promise.resolve({ type: "session_state", messages: [], turns: [], status: "idle", steer: [], followUp: [] }),
        ...
        runExtensionCommand: () => Promise.reject(new Error("agent not available in preview env")),
