...
export interface AgentLoopConfig extends SimpleStreamOptions {
    ...
    /**
     * Called before a user message is added to the active model context.
     *
     * The callback is awaited for initial prompts, queued next-turn messages,
     * steering messages, and follow-up messages.
     */
