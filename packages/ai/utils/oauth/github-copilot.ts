...
import type { OAuthCredentials, OAuthDeviceCodeInfo, OAuthLoginCallbacks, OAuthProviderInterface } from "./types";
...
async function startDeviceFlow(domain: string): Promise<DeviceCodeResponse> {
	...
	return {
		...
		verification_uri: verificationUri as string,
		interval: interval as number,
		expires_in: expiresIn as number,
	};
}
