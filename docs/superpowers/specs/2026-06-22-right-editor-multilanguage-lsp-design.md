...
| Phase 1: Design | In progress | This document captures registry, workspace reuse, Go sample, and status UI. |
| Phase 2: Plan | Not started | Create implementation plan after design approval. |
| Phase 3: Registry Refactor | Not started | Add registry while preserving JS/TS behavior. |
...
| Phase 6: Verification | Not started | Unit, lifecycle, UI, and Go fixture validation. |
