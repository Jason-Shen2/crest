...
//
// Image MIME sniffing. Ported verbatim from pi's
// packages/coding-agent/src/utils/mime.ts (earendil-works/pi, MIT).
//
// Pure Node byte-signature detection — no native/WASM dependencies.
// Detects JPEG/PNG/GIF/WEBP/BMP; rejects animated PNG and CMYK JPEG.
