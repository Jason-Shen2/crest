...
//
// Incrementally tracks streaming command output with bounded memory:
// keeps only a decoded rolling tail for display snapshots and spills the
// full output to a temp file once it exceeds the limits. Ported verbatim
// from pi's packages/coding-agent/src/core/tools/output-accumulator.ts
...
import { DEFAULT_MAX_BYTES, DEFAULT_MAX_LINES, type TruncationResult, truncateTail } from "./_truncate";
...
export class OutputAccumulator {
    ...
    constructor(options: OutputAccumulatorOptions = {}) {
        ...
        this.tempFilePrefix = options.tempFilePrefix ?? "crest-output";
    }
